...
black_jeans = Clothing.create(name: "High Waisted Skinny Jeans", brand: "Levi's", category: "Bottoms", color: "Black", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRlHxDApGI8Lwu6WV0MwBEX3A7Mbybevgi5sg&usqp=CAU", user_id: blaire.id)
blue_jeans = Clothing.create(name: "Boyfriend Jeans", brand: "Madewell", category: "Bottoms", color: "Blue", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT2e18DX9p9KXpRo8umRDPjmeI85-HJAH9zCA&usqp=CAU", user_id: blaire.id)
striped_top = Clothing.create(name: "Striped Tee", brand: "Madewell", category: "T-Shirts", color: "Multi", image: "https://i.s-madewell.com/is/image/madewell/H2671_KA4133_ld?wid=500&hei=635&fmt=jpeg&fit=crop&qlt=75,1&resMode=bisharp&op_usm=0.5,1,5,0", user_id: blaire.id)
white_tee = Clothing.create(name: "White Tee", brand: "Uniqlo", category: "T-Shirts", color: "White", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRJ18omBFWcI9FkMbUSJgWVcKNJYLQTZ_EdTv83i9Gi1DmJ2pG-Aex84zznAlmQVvO-DaD_T58T3A&usqp=CAc", user_id: blaire.id)
